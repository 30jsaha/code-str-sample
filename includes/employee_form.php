<div class="row">
    <div class="col-md-4 col-lg-4 col-sm-12">
        <div class="form-outline">
            <label class="form_label" for="emp_id">Employee ID</label><?= getAsterics(); ?>
        ...
        <div class="input-group mb-3">
            ...
            <input type="text" class="form-control" placeholder="800123" value="<?=$employee_auto_id?>" aria-label="Username" aria-describedby="basic-addon1" id="emp_id">
        </div>
    </div>
    <div class="col-md-4 col-lg-4 col-sm-12">
        <div class="form-outline">
            <label class="form_label" for="emp_department">Select Department</label><?= getAsterics(); ?>
    ...
    <div class="col-md-4 col-lg-4 col-sm-12">
        <div class="form-outline">
            <label class="form_label" for="emp_desig_id">Select Designation</label><?= getAsterics(); ?>
...
<fieldset class="fldset mt-3">
    ...
    <div class="row mt-2">
        <div class="col-md-4 col-lg-4 col-sm-12">
            <div class="form-outline">
                <label class="form_label" for="emp_mobile">Personal Contact Number</label><?= getAsterics(); ?>
                <input type="text" id="emp_mobile" class="form-control" />
            </div>
        </div>
        <div class="col-md-4 col-lg-4 col-sm-12">
            <div class="form-outline">
                <label class="form_label" for="emp_email">Personal Email</label><?= getAsterics(); ?>
...
<fieldset class="fldset mt-3">
    ...
    <div class="row">
        <div class="col-md-6 col-lg-6 col-sm-12">
            <label class="form_label">Select User Type</label><?=getAsterics();?>
            <select class="form-control" id="employee_user_type">
