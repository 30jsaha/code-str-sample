...
<div class="row" style="margin-top: 20px;">
	<div class="col-sm-12 col-md-12 col-lg-12 text-center">
		<img class="img-fluid" src="<?=COMPANY_LOGO_PATH?>" style="width: 10%; padding-top: 20px;">
	</div>
	<div class="col-sm-12 col-md-12 col-lg-12 text-left">
		<h2>Welcome to Our <?=COMPANY_NAME?>'s CRM Portal</h2>
	</div>
</div>
...
<div class="container" id="container" style="margin-top: 10px; margin-bottom:20px;">
	...
	<script>
		...
		$("#backToHome").on('click', () => {
			window.location.href = "https://paperlinksoftwares.com";
			return false;
		});
