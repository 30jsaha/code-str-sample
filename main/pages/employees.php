...
if (count($getEmpData)>0) {
    ...
    <td colspan="14">
        <div class="alert alert-danger" role="alert">
            No Employees found ! <a style="text-decoration: underline; font-weight: bold;" href="'.HOST_URL.'add-employee">Click Here</a> to add Employees First.
        </div>
    </td>
    </tr>';
}
...
<h2 class="text-center">All Employees are Listed Here</h2>
<!-- <div class="row">
    <div class="col-sm-10 col-md-10 col-lg-10 text-right">
        <h2 class="text-center">All Employees are Listed Here</h2>
    </div>
    <div class="col-sm-2 col-md-2 col-lg-2 text-right" id="list_nav_btn">
        <button class="btn btn-primary" name="list" onclick="changeNavigateBtn('employee');">View List</button>
    </div>
</div> -->
            ...
            <input type="hidden" style="visibility: hidden; display:none;" value="<?=$user_id?>" id="employee_user_id" />
                <div class="row mt-4">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 text-right">
                        <button type="button" class="btn btn-success sbmt" data-id="" id="emp_update_btn">
                            Update
                        </button>
                    </div>
                </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row">
            <div class="col-md-6 col-lg-6 col-sm-12">
                ...
                <select class="form-control" id="emp_inactive_reason">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" id="emp_modal_update_btn">Update</button>
      </div>
    </div>
  </div>
</div>
