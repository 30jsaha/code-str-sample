...
function printContent() {
    ...
    // exit;
?>
<h4 class="text-center">Welcome to profile page</h4>
    ...
    <fieldset class="fldset mt-3 mb-5">
        ...
        <div class="row">
            <div class="col-6 text-left">
                User Type: <span class="text-primary" style="font-weight: bold;"><?=USERS[$_SESSION[USER_TYPE]]?></span>
            </div>
        </div>
        <div class="row mt-2">
        ...
        <div class="row mt-2">
            <div class="col-md-12 col-lg-12 col-sm-12 text-right mt-3">
                <button class="btn btn-success" type="button" id="admin_profile_update">Update</button>
            </div>
        </div>
    </fieldset>
<?php
    ...
    switch ($_SESSION[USER_TYPE]) {
        ...
        case MANAGER:
        case ADMIN:
            $name = $emp_id = $designation = $department = $date_of_joinning = $salary = $payroll = $webmail = $personal_contact = $personal_email = $blood_group = $father_name = $mother_name = $current_address = $permanent_address = $emergency_person_name = $emergency_person_number = $aadhaar_number = $pan_number = $salary_account_number = $salary_account_ifsc = $uan_number = $esic_number = $reporting_time = $reporting_manager = "";
    ...
    ?>
        <div class="row">
            ...
            <div class="col-md-6 col-lg-6 col-sm-12">
                ...
                <input type="text" disabled class="form-control" value="<?=$emp_id?>">
            </div>
        </div>
        <div class="row">
            <div class="col-md-6 col-lg-6 col-sm-12">
            ...
            <div class="col-md-6 col-lg-6 col-sm-12">
                ...
                <input type="text" disabled class="form-control" value="<?=$department?>">
            </div>
        </div>
        <div class="row">
            <div class="col-md-6 col-lg-6 col-sm-12">
        ...
        <div class="row">
            <div class="col-md-4 col-lg-4 col-sm-12">
                ...
                <input type="text" disabled class="form-control" value="<?=$personal_contact?>">
            </div>
            <div class="col-md-4 col-lg-4 col-sm-12">
                <label class="form_label">Personal Email: </label>
                <input type="text" disabled class="form-control" value="<?=$personal_email?>">
            </div>
            <div class="col-md-4 col-lg-4 col-sm-12">
